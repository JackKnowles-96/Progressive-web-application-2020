        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                ...
                <form action="PHP/CreateAccount.php" method="POST">
                    <p>
                        <Label>Username:</Label>
                        <input type="text" id="CUserInput" name="CUserInput" />
                    </p>
                    <p>
                        <Label>Password:&nbsp;</Label>
                        <input type="password" id="CPassInput" name="CPassInput" />
                    </p>
                    <p>
                        <input class="btn btn-custom" type="submit" id="btn2" value="Create Account" />
                    </p>
                </form>
            </div>
            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4"></div>
